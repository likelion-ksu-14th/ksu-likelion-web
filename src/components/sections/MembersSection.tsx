...
const membersData: Member[] = [
  {
    ...
    filter: "대표",
    questions: [
      { q: "나에게 멋사란?", a: "가능성을 현실로 끌어당기는 공간입니다. 처음엔 막연했던 '서비스를 만들고 싶다'는 생각이 멋사를 통해 실제 결과물로 이어지는 걸 경험했습니다. 그 순간이 제가 대표를 맡기로 결심한 이유이기도 합니다." },
      { q: "대표로서 가장 신경 쓰는 부분은?", a: "누구 하나 낙오하지 않도록 환경을 만드는 것입니다. 잘하는 사람이 더 빛날 수 있도록 돕는 것도 중요하지만, 시작이 두렵고 막막한 사람이 첫 발을 내딛을 수 있도록 곁에 있는 게 대표가 할 일이라고 생각합니다." },
      { q: "14기 지원자에게 한 마디?", a: "완벽하게 준비된 사람은 없습니다. 지금 당신이 느끼는 설레임과 두려움, 그게 바로 시작의 신호입니다. 일단 문을 두드려 주세요, 나머지는 우리가 함께 해결합니다." },
    ],
  },
  {
    name: "김도현",
